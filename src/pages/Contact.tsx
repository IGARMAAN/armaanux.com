...
export const Contact = () => {
    ...
    return (
        <section
            id="contact"
            className="w-full px-20 space-y-5 container py-14 pt-0 sm:py-32 relative"
        >
            <h1 className="text-2xl md:text-3xl font-heading text-black dark:text-white">
                Contact me
            </h1>
            <p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col w-2/3 gap-4">
                ...
                <div className="flex flex-row justify-between items-center">
                    <span className="flex flex-row justify-between items-center gap-2">
                        <Exclamationsvg />
                        Your information is safe and will remain confidential.
                    </span>
                    <button
                        type="submit"
